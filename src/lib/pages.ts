import { accreditedMosques, newsCards, standards, type CardLink } from "@/lib/content";
import { legacyRouteItems, type LegacyRouteItem } from "@/lib/legacy-routes";
import { getWordPressFallbackPage, getWordPressPublicSlugs } from "@/lib/wordpress-source";
...
export type PageSection =
  ...
  | { kind: "standards" }
  | { kind: "accredited" }
  | { kind: "criteria"; title: string; groups: Array<{ title: string; items: string[] }> }
  | { kind: "form"; form: PageForm; title: string; text: string; defaultCategory?: string };
...
const awardCategoryNominations = [
  { title: "Best Run Mosque", href: "/best-run-mosque-2026-nomination/" },
  { title: "Best Youth Service", href: "/best-youth-service-nominatioin-2026/" },
  { title: "Best Madrassah Service", href: "/best-madrassah-award-nomination-2026/" },
  { title: "Best Women's Service", href: "/best-womens-service-nomination-mosque-2026/" },
  { title: "Most Impactful Imam", href: "/most-impactful-imam-nomination-2026/" },
  { title: "Best Convert Support Service", href: "/best-convert-care-nomination-mosque-2026/" },
  { title: "Most Impactful Alimah", href: "/most-impactful-alimah-nomination-2026/" },
  { title: "Best Outreach Services", href: "/best-outreach-service-nomination-2026/" },
  { title: "Best Future Design", href: "/best-future-design-nomination-mosque-2026/" },
  { title: "Best Mosque Volunteer", href: "/best-mosque-volunteer-nomination-2026/" },
];

const awardCategories = awardCategoryNominations.map((category) => category.title);

const awardCategoryCards: CardLink[] = awardCategoryNominations.map((category) => ({
  title: category.title,
  text: "Recognising outstanding community service, leadership and measurable excellence.",
  href: category.href,
  meta: "Nominate",
}));

const awardRecognitionProfiles2025 = [
  {
    ...
    status: "Winner",
    summary: "Recognised in the 2025 Beacon Mosque Awards for excellent mosque leadership, service delivery and community contribution.",
  },
  {
    ...
    category: "Best Run Mosque",
    status: "Winner",
    summary: "Recognised in the 2025 awards for strong mosque service and community-centred work.",
  },
  {
  ...
  {
    title: "Bilal Masjid Trust - Shortlisted for Best Youth Services Mosque 2025",
    href: "/best-youth-services-2025-shortlisted-mosques-bilal-masjid-trust/",
    category: "Best Youth Service",
    status: "Shortlisted",
    summary: "A shortlisted profile for youth service excellence in the 2025 awards.",
  },
  {
    title: "Lantern Academy / Goldon Mosque - Shortlisted for Best Youth Services Mosque 2025",
    href: "/lantern-academy-shortlisted-for-best-youth-services-mosque-2025/",
    category: "Best Youth Service",
    status: "Shortlisted",
    summary: "A shortlisted youth services profile from the 2025 Beacon Mosque Awards.",
  },
  {
    title: "Lozells Central Mosque - Shortlisted for Best Youth Services Mosque 2025",
  ...
  {
    title: "Al-Abbas Islamic Centre - Shortlisted for Best Madrassah Services 2025",
  ...
  {
    title: "Taqwa Institute - Shortlisted for Best Madrassah Services Mosque 2025",
  ...
  {
    title: "Masjid Al Falaah - Shortlisted for Best Women's Services Mosque 2025",
  ...
  },
  {
    ...
    status: "Winner",
    summary: "Recognised for future design and for work that connects mosque facilities with wider community engagement.",
  },
  {
  ...
  },
  {
    ...
    status: "Winner",
    summary: "Recognised for outreach, community support, youth activity, education and civic partnership work.",
  },
  {
    ...
    category: "Best Outreach Services",
    status: "Winner",
    summary: "A 2025 Best Outreach Services profile from the Beacon Mosque Awards.",
  },
  {
  ...
  {
    title: "Mohammad Akram - Markazi Jamia Ghausia - Best Best Mosque Volunteer 2025",
    href: "/mohammad-akram-best-best-mosque-volunteer-2025/",
    category: "Best Mosque Volunteer",
    status: "Finalist",
    summary: "A volunteer profile recognising decades of service to Markazi Jamia Ghausia Masjid in Nelson.",
  },
  {
    ...
    category: "Best Mosque Volunteer",
    status: "Finalist",
    summary: "A 2025 Best Mosque Volunteer profile from the Beacon Mosque Awards.",
  },
  {
    ...
    status: "Finalist",
    summary: "Recognised for Islamic learning, chaplaincy, end-of-life care advocacy and community teaching.",
  },
  {
    title: "Muftiyah Nasima Umm Hamza - Finalist for Most Impactful Alimah 2025",
  ...
  {
    title: "Shaykh Dr. Saalim Al-Azhari - Shortlisted for Most Impactful Imam 2025",
  ...
  },
  {
    ...
    category: "Most Impactful Imam",
    status: "Shortlisted",
    summary: "Recognised for Islamic education, mentorship, youth development and community leadership.",
  },
  {
    title: "Islamic Association of North London (IANL) - Finalist for Best Convert System 2025",
...
const awardRecognitionCards2025: CardLink[] = awardRecognitionProfiles2025.map((profile) => ({
  title: profile.title,
...
const awardCategoryPages2025 = [
  ...
  { title: "Best Youth Service", href: "/beacon-mosque-award-2025-youth-voting/" },
  { title: "Best Madrassah Service", href: "/beacon-mosque-award-2025-voting-madrassah/" },
  ...
  { title: "Best Convert Support Service", href: "/beacon-mosque-award-2025-convert/" },
  { title: "Most Impactful Alimah", href: "/beacon-mosque-award-2025-voting-alimah/" },
  { title: "Best Outreach Services", href: "/beacon-mosque-award-2025-voting-outreach/" },
  { title: "Best Future Design", href: "/beacon-mosque-award-2025-voting-future-design/" },
  { title: "Best Mosque Volunteer", href: "/beacon-mosque-award-2025-voting-volunteer/" },
];

const awardCategoryHref2025 = Object.fromEntries(awardCategoryPages2025.map((category) => [category.title, category.href]));

const awardRecognitionProfiles2024 = [
  { title: "Bilal Academy Shortlisted Mosque - Best Run Mosque 2024", href: "/bilal-academy-shortlisted-mosque-best-run-mosque2024/", category: "Best Run Mosque", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Run Mosque category." },
  { title: "Chesham Mosque Shortlisted Mosque - Best Run Mosque 2024", href: "/chesham-mosque-shortlisted-mosque-best-run-mosque2024/", category: "Best Run Mosque", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Run Mosque category." },
  { title: "Golden Mosque Shortlisted Mosque - Best Run Mosque 2024", href: "/golden-mosque-shortlisted-mosque-best-run-mosque2024-2/", category: "Best Run Mosque", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Run Mosque category." },
  { title: "Aberdeen Mosque & Islamic Centre Shortlisted Mosque - Best Youth Service 2024", href: "/abderdeen-mosque-islamic-centre-shortlisted-mosque-best-youth-service-2024/", category: "Best Youth Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Youth Service category." },
  { title: "Bracknell Islamic Cultural Society Shortlisted Mosque - Best Youth Service 2024", href: "/bracknell-islamic-cultural-society-shortlisted-mosque-best-youth-service-2024/", category: "Best Youth Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Youth Service category." },
  { title: "Masjid Millat-E-Islamia Shortlisted Mosque - Best Youth Service 2024", href: "/masjid-millat-e-islamia-shortlisted-mosque-best-youth-service-2024/", category: "Best Youth Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Youth Service category." },
  { title: "Al Furqan - Shortlisted - Best Madrassah Service 2024", href: "/al-furqan-madrassah-shortlisted-mosque-2024/", category: "Best Madrassah Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Madrassah Service category." },
  { title: "Bayt Al Qaim Islamic Centre - Shortlisted - Best Madrassah Service 2024", href: "/bayt-al-qaim-islamic-centre-shortlisted-best-madrassah-service-2024-2/", category: "Best Madrassah Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Madrassah Service category." },
  { title: "Masjid Muadh Ibn Jabal - Shortlisted - Best Madrassah Service 2024", href: "/masjid-muadh-ibn-jabal-shortlisted-best-madrassah-service-2024/", category: "Best Madrassah Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Madrassah Service category." },
  { title: "The Hub - Shortlisted - Best Madrassah Service 2024", href: "/the-hub-madrassah-shortlisted-mosque-2024/", category: "Best Madrassah Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Madrassah Service category." },
  { title: "Hayes Muslim Centre - Shortlisted Best Madrassah Service 2024", href: "/shortlisted-best-madrassah-service-2024-hayes-muslim-centre/", category: "Best Madrassah Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Madrassah Service category." },
  { title: "Al Furqan Islamic Centre Shortlisted Mosque - Best Women's Service 2024", href: "/al-furqan-shortlisted-mosque-best-womens-service-2024/", category: "Best Women's Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Women's Service category." },
  { title: "Jamia Al Maarif Shortlisted Mosque - Best Women's Service 2024", href: "/jamia-al-maarif-shortlisted-mosque-best-womens-service-2024/", category: "Best Women's Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Women's Service category." },
  { title: "Nelson Community Mosque Shortlisted Mosque - Best Women's Service 2024", href: "/nelson-community-mosque-shortlisted-mosque-best-youth-service-2024/", category: "Best Women's Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Women's Service category." },
  { title: "Ameenia Sultania Educational Trust Shortlisted Mosque - Best Future Design 2024", href: "/ameenia-sultania-educational-trust-shortlisted-mosque-best-future-design-2024/", category: "Best Future Design", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Future Design category." },
  { title: "Quba Masjid Shortlisted Mosque - Best Future Design 2024", href: "/quba-masjid-shortlisted-mosque-best-future-design-2024/", category: "Best Future Design", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Future Design category." },
  { title: "Salaam Centre Shortlisted Mosque - Best Future Design 2024", href: "/salaam-centre-shortlisted-mosque-best-future-design-2024/", category: "Best Future Design", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Future Design category." },
  { title: "East London Mosque Shortlisted Mosque - Best Convert Care 2024", href: "/east-london-mosque-shortlisted-mosque-best-convert-service-2024/", category: "Best Convert Support Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Convert Care category." },
  { title: "Green Lane Masjid Shortlisted Mosque - Best Convert Care 2024", href: "/green-lane-masjid-shortlisted-mosque-best-convert-care-service-2024/", category: "Best Convert Support Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Convert Care category." },
  { title: "The Olton Project Shortlisted Mosque - Best Convert Care 2024", href: "/the-olton-project-shortlisted-mosque-best-convert-care-service-2024/", category: "Best Convert Support Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Convert Care category." },
  { title: "Al Manaar Shortlisted Mosque - Best Innovation Service 2024", href: "/al-manaar-shortlisted-mosque-best-innovation-service-2024/", category: "Best Innovative Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Innovative Service category." },
  { title: "Central Jamia Mosque Madni Shortlisted Mosque - Best Innovation Service 2024", href: "/central-jamia-masjid-shortlisted-mosque-best-innovation-service-2024/", category: "Best Innovative Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Innovative Service category." },
  { title: "Wycombe Islamic Mission Shortlisted Mosque - Best Innovation Service 2024", href: "/wycombe-islamic-mission-shortlisted-mosque-best-innovation-service-2024/", category: "Best Innovative Service", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Best Innovative Service category." },
  { title: "Adam Kelwick - Shortlisted - Most Impactful Imam 2024", href: "/adam-kelwick-shortlisted-most-impactful-imam-2024/", category: "Most Impactful Imam", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Most Impactful Imam category." },
  { title: "Mufti Muhammad Tosir Miah - Shortlisted - Most Impactful Imam 2024", href: "/mufti-muhammad-tosir-miah-shortlisted-most-impactful-imam-2024/", category: "Most Impactful Imam", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Most Impactful Imam category." },
  { title: "Shaykh Omar Ali - Shortlisted - Most Impactful Imam 2024", href: "/shaykh-omar-ali-shortlisted-most-impactful-imam-2024/", category: "Most Impactful Imam", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Most Impactful Imam category." },
  { title: "Fatima Qasmi Shortlisted Most Impactful Alimah 2024", href: "/fatima-qasmi-shortlisted-most-impactful-alimah-2024/", category: "Most Impactful Alimah", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Most Impactful Alimah category." },
  { title: "Saleha Islam Shortlisted Most Impactful Alimah 2024", href: "/saleha-islam-shortlisted-most-impactful-alimah-2024/", category: "Most Impactful Alimah", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Most Impactful Alimah category." },
  { title: "Ustadha Nagebah Hayel Shortlisted Most Impactful Alimah 2024", href: "/ustadha-nagebah-hayel-shortlisted-most-impactful-alimah-2024/", category: "Most Impactful Alimah", status: "Shortlisted", summary: "A shortlisted profile in the 2024 Most Impactful Alimah category." },
  { title: "Best Mosque Volunteer Shortlist 2024", href: "/best-mosque-volunteer-shortlist-2024/", category: "Best Mosque Volunteer", status: "Shortlisted", summary: "A 2024 shortlist page in the Best Mosque Volunteer category." },
];

const awardRecognitionCards2024: CardLink[] = awardRecognitionProfiles2024.map((profile) => ({
  title: profile.title,
  text: profile.summary,
  href: profile.href,
  meta: profile.status,
...
const awardCategoryPages2024 = [
  ...
  { title: "Best Convert Support Service", href: "/best-convert-support-service-2024/" },
...
const awardCategoryHref2024 = Object.fromEntries(awardCategoryPages2024.map((category) => [category.title, category.href]));
...
const awardCategoryPages2023 = [
  ...
  { title: "Best Convert Support Service", href: "/best-convert-support-service-2023/" },
...
const awardCategoryHref2023 = Object.fromEntries(awardCategoryPages2023.map((category) => [category.title, category.href]));
...
const awardCategoryPages2022 = [
  ...
  { title: "Best Convert Support Service", href: "/best-convert-support-service-2022/" },
...
const awardCategoryHref2022 = Object.fromEntries(awardCategoryPages2022.map((category) => [category.title, category.href]));

const awardFinalistPages2022 = [
  { title: "Best Run Mosque 2022 Finalists", href: "/best-run-mosque-2022-finalists/", category: "Best Run Mosque" },
  { title: "Best Youth Service 2022 Finalists", href: "/best-youth-service-2022-finalists/", category: "Best Youth Service" },
  { title: "Best Madrassah Service 2022 Finalists", href: "/best-madrassah-service-2022-finalists/", category: "Best Madrassah Service" },
  { title: "Best Women's Service 2022 Finalists", href: "/best-womens-service-2022-finalists/", category: "Best Women's Service" },
  { title: "Most Impactful Imam 2022 Finalists", href: "/most-impactful-imam-2022-finalists/", category: "Most Impactful Imam" },
  { title: "Best Convert Support Service Award 2022 Finalists", href: "/best-convert-support-service-2022-finalists/", category: "Best Convert Support Service" },
  { title: "Most Impactful Alimah 2022 Finalists", href: "/most-impactful-alimah-2022-finalists/", category: "Most Impactful Alimah" },
  { title: "Best Outreach Service 2022 Finalists", href: "/best-outreach-service-2022-finalists/", category: "Best Outreach Service" },
  { title: "Best Future Design Award 2022 Finalists", href: "/best-future-design-2022-finalists/", category: "Best Future Design" },
  { title: "Best Mosque Volunteer Award 2022 Finalists", href: "/best-mosque-volunteer-2022-finalists/", category: "Best Mosque Volunteer" },
  { title: "Most Innovative Service 2022 Finalists", href: "/most-innovative-service-2022-finalists/", category: "Most Innovative Service" },
];

const awardVotePages2022 = [
  { title: "Best Run Mosque 2022 Vote", href: "/best-run-mosque-2022-vote/", category: "Best Run Mosque" },
  { title: "Best Youth Service 2022 Vote", href: "/best-youth-service-2022-vote/", category: "Best Youth Service" },
  { title: "Best Madrassah Service 2022 Vote", href: "/best-madrassah-service-2022-vote/", category: "Best Madrassah Service" },
  { title: "Best Women's Service 2022 Vote", href: "/best-womens-service-2022-vote/", category: "Best Women's Service" },
  { title: "Most Impactful Imam 2022 Vote", href: "/most-impactful-imam-2022-vote/", category: "Most Impactful Imam" },
  { title: "Best Convert Support 2022 Vote", href: "/best-convert-support-2022-vote/", category: "Best Convert Support Service" },
  { title: "Most Impactful Alimah 2022 Vote", href: "/most-impactful-alimah-2022-vote/", category: "Most Impactful Alimah" },
  { title: "Best Outreach Service 2022 Vote", href: "/best-outreach-service-2022-vote/", category: "Best Outreach Service" },
  { title: "Best Future Design 2022 Vote", href: "/best-future-design-2022-vote/", category: "Best Future Design" },
  { title: "Best Mosque Volunteer 2022 Vote", href: "/best-mosque-volunteer-2022-vote/", category: "Best Mosque Volunteer" },
  { title: "Most Innovative Service 2022 Vote", href: "/most-innovative-service-2022-vote/", category: "Most Innovative Service" },
];

const awardRecognitionProfiles2022 = [
  { title: "Hounslow Muslim Centre - Shortlisted - Best Run Mosque 2022", href: "/hounslow-muslim-centre-shortlisted-best-run-mosque-2022/", category: "Best Run Mosque" },
  { title: "Maidenhead Mosque & Islamic Centre - Shortlisted - Best Run Mosque 2022", href: "/maidenhead-mosque-islamic-centre-shortlisted-best-run-mosque-2022/", category: "Best Run Mosque" },
  { title: "Leeds Grand Mosque - Shortlisted - Best Run Mosque 2022", href: "/leeds-grand-mosque-shortlisted-best-run-mosque-2022/", category: "Best Run Mosque" },
  { title: "Bilal Academy - Shortlisted - Best Run Mosque 2022", href: "/bilal-academy-shortlisted-best-run-mosque-2022/", category: "Best Run Mosque" },
  { title: "Al-Hayat Centre - Shortlisted - Best Youth Service 2022", href: "/al-hayat-centre-shortlisted-best-youth-service-2022/", category: "Best Youth Service" },
  { title: "Masjid Al-Falaah - Shortlisted - Best Youth Service 2022", href: "/masjid-al-falaah-shortlisted-best-youth-service-2022/", category: "Best Youth Service" },
  { title: "EMCA Mosque & Centre - Shortlisted - Best Youth Service 2022", href: "/emca-mosque-centre-shortlisted-best-youth-service-2022/", category: "Best Youth Service" },
  { title: "Lantern Academy - Shortlisted - Best Madrassah Service 2022", href: "/lantern-academy-shortlisted-best-madrassah-service-2022/", category: "Best Madrassah Service" },
  { title: "Bayt Al Qaim Islamic Centre - Shortlisted - Best Madrassah Service 2022", href: "/bayt-al-qaim-islamic-centre-shortlisted-best-madrassah-service-2022/", category: "Best Madrassah Service" },
  { title: "Al-Rahma Mosque - Shortlisted - Best Madrassah Service 2022", href: "/al-rahma-mosque-shortlisted-best-madrassah-service-2022/", category: "Best Madrassah Service" },
  { title: "Al-Madani Masjid - Shortlisted - Best Madrassah Service 2022", href: "/al-madani-masjid-shortlisted-best-madrassah-service-2022/", category: "Best Madrassah Service" },
  { title: "Al-Hayat Centre - Shortlisted - Best Madrassah Service 2022", href: "/al-hayat-centre-shortlisted-best-madrassah-service-2022/", category: "Best Madrassah Service" },
  { title: "Guidance Hub - Shortlisted - Best Women's Service 2022", href: "/guidance-hub-shortlisted-best-womens-service-2022/", category: "Best Women's Service" },
  { title: "Dawatal Islam Mosque - Shortlisted - Best Women's Service 2022", href: "/dawatal-islam-mosque-shortlisted-best-womens-service-2022/", category: "Best Women's Service" },
  { title: "Minhaj Ul Quran Birmingham - Shortlisted - Best Women's Service 2022", href: "/minhaj-ul-quran-birmingham-shortlisted-best-womens-service-2022/", category: "Best Women's Service" },
  { title: "Shaykh Rizwan Hussain al-Azhari (Al-Hayat Centre) - Shortlisted - Most Impactful Imam 2022", href: "/rizwan-hussain-al-hayat-centre-shortlisted-most-impactful-imam-2022/", category: "Most Impactful Imam" },
  { title: "Qari Is'Haaq Jasat (London Islamic Cultural Society) - Shortlisted - Most Impactful Imam 2022", href: "/ishaaq-jasat-shortlisted-most-impactful-imam-2022/", category: "Most Impactful Imam" },
  { title: "Imam Ebrahim Esakjee (Bilal Academy) - Shortlisted - Most Impactful Imam 2022", href: "/ebrahim-esakjee-shortlisted-most-impactful-imam-2022/", category: "Most Impactful Imam" },
  { title: "York Mosque & Islamic Centre - Shortlisted - Best Convert Support 2022", href: "/york-mosque-islamic-centre-shortlisted-best-convert-support-2022/", category: "Best Convert Support Service" },
  { title: "Jamia Almaarif - Shortlisted - Best Convert Support 2022", href: "/jamia-almaarif-shortlisted-best-convert-support-2022/", category: "Best Convert Support Service" },
  { title: "Hockwell Ring Masjid - Shortlisted - Best Convert Support 2022", href: "/hockwell-ring-masjid-shortlisted-best-convert-support-2022/", category: "Best Convert Support Service" },
  { title: "Ustadha Uzma Minhas (Hubb Education) - Shortlisted - Most Impactful Alimah 2022", href: "/uzma-minhas-shortlisted-most-impactful-alimah-2022/", category: "Most Impactful Alimah" },
  { title: "Ustadha Sidrah Ahmed (Al-Hayat Centre) - Shortlisted - Most Impactful Alimah 2022", href: "/sidrah-ahmed-shortlisted-most-impactful-alimah-2022/", category: "Most Impactful Alimah" },
  { title: "Ustadha Ameena Blake (Markfield Institute) - Shortlisted - Most Impactful Alimah 2022", href: "/ameena-blake-shortlisted-most-impactful-alimah-2022/", category: "Most Impactful Alimah" },
  { title: "Dawatal Islam Mosque - Shortlisted - Best Outreach Service 2022", href: "/dawatal-islam-mosque-shortlisted-best-outreach-service-2022/", category: "Best Outreach Service" },
  { title: "Nelson Community Masjid - Shortlisted - Best Outreach Service 2022", href: "/nelson-community-masjid-shortlisted-best-outreach-service-2022/", category: "Best Outreach Service" },
  { title: "Bashir Ahmed Masjid - Shortlisted - Best Outreach Service 2022", href: "/bashir-ahmed-masjid-shortlisted-best-outreach-service-2022/", category: "Best Outreach Service" },
  { title: "Al-Manaar - Shortlisted - Best Outreach Service 2022", href: "/al-manaar-shortlisted-best-outreach-service-2022/", category: "Best Outreach Service" },
  { title: "UK Albanian Muslim Community & Cultural Centre - Shortlisted - Best Future Design 2022", href: "/uk-albanian-muslim-community-cultural-centre-shortlisted-best-future-design-2022/", category: "Best Future Design" },
  { title: "Madinat al Zahra - Shortlisted - Best Future Design 2022", href: "/madinat-al-zahra-shortlisted-best-future-design-2022/", category: "Best Future Design" },
  { title: "Iqra Learning Centre Glasgow - Shortlisted - Best Future Design 2022", href: "/iqra-learning-centre-glasgow-shortlisted-best-future-design-2022/", category: "Best Future Design" },
  { title: "Mahmood M Sacha (Masjid-E-Umar) - Shortlisted - Best Mosque Volunteer 2022", href: "/mahmood-m-sacha-shortlisted-best-mosque-volunteer-2022/", category: "Best Mosque Volunteer" },
  { title: "Noor Miah (Shah Jalal Mosque) - Shortlisted - Best Mosque Volunteer 2022", href: "/noor-miah-shortlisted-best-mosque-volunteer-2022/", category: "Best Mosque Volunteer" },
  { title: "Abdul Raoof Malik (Easton Jamia Masjid) - Shortlisted - Best Mosque Volunteer 2022", href: "/abdul-raoof-malik-shortlisted-best-mosque-volunteer-2022/", category: "Best Mosque Volunteer" },
  { title: "Safiyya Dhorat (Masjid Nuh) - Shortlisted - Best Mosque Volunteer 2022", href: "/safiyya-dhorat-shortlisted-best-mosque-volunteer-2022/", category: "Best Mosque Volunteer" },
  { title: "Leeds Grand Mosque - Shortlisted - Most Innovative Service 2022", href: "/leeds-grand-mosque-shortlisted-most-innovative-service-2022/", category: "Most Innovative Service" },
  { title: "Hounslow Jamia Masjid & Islamic Centre - Shortlisted - Most Innovative Service 2022", href: "/hounslow-jamia-masjid-islamic-centre-shortlisted-most-innovative-service-2022/", category: "Most Innovative Service" },
  { title: "Al-Madina Mosque Barking - Shortlisted - Most Innovative Service 2022", href: "/al-madina-mosque-barking-shortlisted-most-innovative-service-2022/", category: "Most Innovative Service" },
].map((profile) => ({
  ...profile,
  status: "Shortlisted",
...
const awardRecognitionCards2022: CardLink[] = awardRecognitionProfiles2022.map((profile) => ({
  title: profile.title,
  text: profile.summary,
  href: profile.href,
  meta: profile.status,
...
const awardFinalistCards2022: CardLink[] = awardFinalistPages2022.map((page) => ({
  title: page.title,
...
const awardCategoryPages2021 = [
  { title: "Best Run Mosque", href: "/best-run-mosque-2021/", aliases: ["/best-run-mosque-2021-b-2/"] },
  { title: "Best Youth Service", href: "/best-youth-service-2021/", aliases: ["/best-youth-service-2021-b/"] },
  { title: "Best Madrassah Service", href: "/best-madrassah-service-2021/", aliases: ["/best-madrassah-service-2021-b/"] },
  { title: "Best Women's Service", href: "/best-womens-service-2021/", aliases: ["/best-womens-service-2021-b/"] },
  { title: "Most Impactful Imam", href: "/most-impactful-imam-2021/", aliases: ["/most-impactful-imam-2021-b/"] },
  { title: "Most Impactful Alimah", href: "/most-impactful-alimah-2021/", aliases: ["/most-impactful-alimah-2021-b/"] },
  { title: "Best Outreach Service", href: "/best-outreach-service-2021/", aliases: ["/best-outreach-service-2021-b/"] },
  { title: "Best Elderly Service", href: "/best-elderly-service-2021/" },
  { title: "Best Green Initiative", href: "/best-green-initiative-2021/", aliases: ["/best-green-initiative-2021-b/"] },
  { title: "Most Innovative Service", href: "/most-innovative-service-2021/", aliases: ["/most-innovative-service-2021-b/"] },
];

const awardCategoryHref2021 = Object.fromEntries(awardCategoryPages2021.map((category) => [category.title, category.href]));
awardCategoryHref2021["Best Future Design"] = "/best-future-design-2021-vote/";

const awardVotePages2021 = [
  { title: "Best Run Mosque 2021 Vote", href: "/best-run-mosque-2021-vote/", category: "Best Run Mosque" },
  { title: "Best Youth Service 2021 Vote", href: "/best-youth-service-2021-vote/", category: "Best Youth Service" },
  { title: "Best Madrassah Service 2021 Vote", href: "/best-madrassah-service-2021-vote/", category: "Best Madrassah Service" },
  { title: "Best Women's Service 2021 Vote", href: "/best-womens-service-2021-vote/", category: "Best Women's Service" },
  { title: "Most Impactful Imam 2021 Vote", href: "/most-impactful-imam-2021-vote/", category: "Most Impactful Imam" },
  { title: "Most Impactful Alimah 2021 Vote", href: "/most-impactful-alimah-2021-vote/", category: "Most Impactful Alimah" },
  { title: "Best Outreach Service 2021 Vote", href: "/best-outreach-service-2021-vote/", category: "Best Outreach Service" },
  { title: "Best Elderly Service 2021 Vote", href: "/best-elderly-service-2021-vote/", category: "Best Elderly Service" },
  { title: "Best Green Initiative 2021 Vote", href: "/best-green-initiative-2021-vote/", category: "Best Green Initiative" },
  { title: "Most Innovative Service 2021 Vote", href: "/best-innovative-service-2021-vote/", category: "Most Innovative Service" },
  { title: "Best Future Design 2021 Vote", href: "/best-future-design-2021-vote/", category: "Best Future Design" },
];

const awardResultPages2021 = [
  { title: "Best Run Mosque 2021 Results", href: "/best-run-mosque-2021-results/", category: "Best Run Mosque" },
  { title: "Best Youth Service 2021 Results", href: "/youth-2021-results/", category: "Best Youth Service" },
  { title: "Best Madrassah Service 2021 Results", href: "/madrassah-2021-results/", category: "Best Madrassah Service" },
  { title: "Best Women's Service 2021 Results", href: "/womens-2021-results/", category: "Best Women's Service" },
  { title: "Most Impactful Imam 2021 Results", href: "/imam-2021-results/", category: "Most Impactful Imam" },
  { title: "Most Impactful Alimah 2021 Results", href: "/alimah-2021-results/", category: "Most Impactful Alimah" },
  { title: "Best Outreach Service 2021 Results", href: "/outreach-2021-results/", category: "Best Outreach Service" },
  { title: "Best Green Initiative 2021 Results", href: "/green-2021-results/", category: "Best Green Initiative" },
  { title: "Best Innovative Service 2021 Results", href: "/innovative-2021-results/", category: "Most Innovative Service" },
  { title: "Best Future Design 2021 Results", href: "/future-design-2021-results/", category: "Best Future Design" },
];

const awardRecognitionProfiles2021 = [
  { title: "Sri Lankan Muslim Cultural Centre - Shortlisted - Best Run Mosque 2021", href: "/sri-lankan-muslim-cultural-centre-shortlisted-best-run-mosque-2021/", category: "Best Run Mosque" },
  { title: "Golden Mosque - Shortlisted - Best Run Mosque 2021", href: "/golden-mosque-shortlisted-best-run-mosque-2021/", category: "Best Run Mosque" },
  { title: "Al Manaar - Shortlisted - Best Run Mosque 2021", href: "/al-manaar-shortlisted-best-run-mosque-2021/", category: "Best Run Mosque" },
  { title: "MCEC Palmers Green - Shortlisted - Best Run Mosque 2021", href: "/mcec-palmers-green-shortlisted-best-run-mosque-2021/", category: "Best Run Mosque" },
  { title: "The Emaan Trust - Shortlisted - Best Youth Service 2021", href: "/the-emaan-trust-shortlisted-best-youth-service-2021/", category: "Best Youth Service" },
  { title: "Al Manaar - Shortlisted - Best Youth Service 2021", href: "/al-manaar-shortlisted-best-youth-service-2021/", category: "Best Youth Service" },
  { title: "Lantern Academy - Shortlisted - Best Youth Service 2021", href: "/lantern-academy-shortlisted-best-youth-service-2021/", category: "Best Youth Service" },
  { title: "Aisha Mosque & Islamic Centre - Shortlisted - Best Youth Service 2021", href: "/aisha-mosque-islamic-centre-shortlisted-best-youth-service-2021/", category: "Best Youth Service" },
  { title: "Muhammadi Madrasah - Shortlisted - Best Madrassah Service 2021", href: "/muhammadi-madrasah-shortlisted-best-madrassah-service-2021/", category: "Best Madrassah Service" },
  { title: "Lantern Academy - Shortlisted - Best Madrassah Service 2021", href: "/lantern-academy-shortlisted-best-madrassah-service-2021/", category: "Best Madrassah Service" },
  { title: "Al-Mustafa Centre - Shortlisted - Best Madrassah Service 2021", href: "/al-mustafa-centre-shortlisted-best-madrassah-service-2021/", category: "Best Madrassah Service" },
  { title: "Finsbury Park Mosque - Shortlisted - Best Women's Service 2021", href: "/finsbury-park-mosque-shortlisted-best-womens-service-2021/", category: "Best Women's Service" },
  { title: "Rumi's Cave - Shortlisted - Best Women's Service 2021", href: "/rumis-cave-shortlisted-best-womens-service-2021/", category: "Best Women's Service" },
  { title: "Muslimah Education Center & Arrahman Mosque Women's Forum - Shortlisted - Best Women's Service 2021", href: "/muslimah-education-center-arrahman-mosque-womens-forum-shortlisted-best-womens-service-2021/", category: "Best Women's Service" },
  { title: "Three Meem Foundation - Shortlisted - Best Women's Service 2021", href: "/three-meem-foundation-shortlisted-best-womens-service-2021/", category: "Best Women's Service" },
  { title: "Sheikh Nuru Mohammed - Shortlisted - Most Impactful Imam 2021", href: "/sheikh-nuru-mohammed-shortlisted-most-impactful-imam-2021/", category: "Most Impactful Imam" },
  { title: "Imam Is'Haaq Jasat - Shortlisted - Most Impactful Imam 2021", href: "/imam-ishaaq-shortlisted-most-impactful-imam-2021/", category: "Most Impactful Imam" },
  { title: "Musharraf Hussain - Shortlisted - Most Impactful Imam 2021", href: "/musharraf-hussain-shortlisted-most-impactful-imam-2021/", category: "Most Impactful Imam" },
  { title: "Adam Kelwick - Shortlisted - Most Impactful Imam 2021", href: "/adam-kelwick-shortlisted-most-impactful-imam-2021/", category: "Most Impactful Imam" },
  { title: "Sr Sherifat Muhammad Kamal - Shortlisted - Most Impactful Alimah 2021", href: "/sr-sherifat-muhammad-kamal-shortlisted-most-impactful-alimah-2021/", category: "Most Impactful Alimah" },
  { title: "Maysoon Shafiq - Shortlisted - Most Impactful Alimah 2021", href: "/maysoon-shafiq-shortlisted-most-impactful-alimah-2021/", category: "Most Impactful Alimah" },
  { title: "Ustadhah Misba Khan - Shortlisted - Most Impactful Alimah 2021", href: "/ustadhah-misba-khan-shortlisted-most-impactful-alimah-2021/", category: "Most Impactful Alimah" },
  { title: "Ustadhah Nagheba - Shortlisted - Most Impactful Alimah 2021", href: "/ustadhah-nagheba-shortlisted-most-impactful-alimah-2021/", category: "Most Impactful Alimah" },
  { title: "Al-Rahma Mosque - Shortlisted - Best Outreach Service 2021", href: "/al-rahma-mosque-shortlisted-best-outreach-service-2021/", category: "Best Outreach Service" },
  { title: "Al-Abbas Islamic Centre - Shortlisted - Best Outreach Service 2021", href: "/al-abbas-islamic-centre-shortlisted-best-outreach-service-2021/", category: "Best Outreach Service" },
  { title: "The Mosque and Islamic Centre of Brent - Shortlisted - Best Outreach Service 2021", href: "/the-mosque-and-islamic-centre-of-brent-shortlisted-best-outreach-service-2021/", category: "Best Outreach Service" },
  { title: "Jamiyat Tabligh-ul-Islam Bradford Central Mosque - Shortlisted - Best Outreach Service 2021", href: "/jamiyat-tabligh-ul-islam-bradford-central-mosque-shortlisted-best-outreach-service-2021/", category: "Best Outreach Service" },
  { title: "Hockwell Ring Masjid - Shortlisted - Best Elderly Service 2021", href: "/hockwell-ring-masjid-shortlisted-best-elderly-service-2021/", category: "Best Elderly Service" },
  { title: "The Muath Trust - Shortlisted - Best Elderly Service 2021", href: "/the-muath-trust-shortlisted-best-elderly-service-2021/", category: "Best Elderly Service" },
  { title: "Jamia Masjid Bilal - Shortlisted - Best Green Initiative 2021", href: "/jamia-masjid-bilal-shortlisted-best-green-initiative-2021/", category: "Best Green Initiative" },
  { title: "Easton Mosque - Shortlisted - Best Green Initiative 2021", href: "/eastside-community-trust-shortlisted-best-green-initiative-2021/", category: "Best Green Initiative" },
  { title: "Minhaj-Ul-Quran - Shortlisted - Most Innovative Service 2021", href: "/minhaj-ul-quran-shortlisted-most-innovative-service-2021/", category: "Most Innovative Service" },
  { title: "Al Madina Mosque Barking - Shortlisted - Most Innovative Service 2021", href: "/al-madina-mosque-barking-shortlisted-most-innovative-service-2021/", category: "Most Innovative Service" },
  { title: "Central Mosque of Brent - Shortlisted - Most Innovative Service 2021", href: "/central-mosque-of-brent-shortlisted-best-innovative-service-2021/", category: "Most Innovative Service" },
  { title: "Rumi Mosque - Shortlisted - Most Innovative Service 2021", href: "/rumi-mosque-shortlisted-best-innovative-service-2021/", category: "Most Innovative Service" },
  { title: "Old Kent Road Mosque and Islamic Cultural Centre - Shortlisted - Best Future Design 2021", href: "/old-kent-road-mosque-and-islamic-cultural-centre-shortlisted-best-future-design-2021/", category: "Best Future Design" },
  { title: "Newcastle Central Mosque - Shortlisted Best Future Design 2021", href: "/broughton-mosque-designed-by-luca-poian-shortlisted-best-future-design-2021/", category: "Best Future Design" },
  { title: "Al-Mustafa Centre - Shortlisted - Best Future Design 2021", href: "/al-mustafa-centre-shortlisted-best-future-design-2021/", category: "Best Future Design" },
].map((profile) => ({
  ...profile,
  status: "Shortlisted",
...
const awardRecognitionCards2021: CardLink[] = awardRecognitionProfiles2021.map((profile) => ({
  title: profile.title,
  text: profile.summary,
  href: profile.href,
  meta: profile.status,
...
const awardCategoryPages2020 = [
  ...
  { title: "Best Madrassah Service", href: "/best-madrassah-service-vote-now/" },
  ...
  { title: "Most Innovative Service", href: "/most-innovative-service-vote-now/" },
  { title: "Best Mosque COVID-19 Response", href: "/best-mosque-covid-19-response/" },
  { title: "Best Volunteer", href: "/best-volunteer/" },
];

const awardCategoryHref2020 = Object.fromEntries(awardCategoryPages2020.map((category) => [category.title, category.href]));

const awardVotePages2020 = [
  { title: "Best Run Mosque - Vote Now", href: "/best-run-mosque-vote-now/", category: "Best Run Mosque" },
  { title: "Best Youth Service - Vote Now", href: "/best-youth-service-vote-now/", category: "Best Youth Service" },
  { title: "Best Madrassah Service - Vote Now", href: "/best-madrassah-service-vote-now/", category: "Best Madrassah Service" },
  { title: "Best Women's Service - Vote Now", href: "/best-womens-service-vote-now/", category: "Best Women's Service" },
  { title: "Most Impactful Imam - Vote Now", href: "/most-impactful-imam-vote-now/", category: "Most Impactful Imam" },
  { title: "Most Impactful Alimah - Vote Now", href: "/most-impactful-alimah-vote-now/", category: "Most Impactful Alimah" },
  { title: "Best Outreach Service - Vote Now", href: "/best-outreach-service-vote-now/", category: "Best Outreach Service" },
  { title: "Best Elderly Service - Vote Now", href: "/best-elderly-service-vote-now/", category: "Best Elderly Service" },
  { title: "Best Green Initiative - Vote Now", href: "/best-green-initiative-vote-now/", category: "Best Green Initiative" },
  { title: "Most Innovative Service - Vote Now", href: "/most-innovative-service-vote-now/", category: "Most Innovative Service" },
  { title: "COVID-19 Response - Vote Now", href: "/covid-19-response-vote-now/", category: "Best Mosque COVID-19 Response" },
];

const awardProgrammePages2020 = [
  { title: "Atelier UWA Architects - Sponsoring the 3rd British Beacon Mosque Awards 2020", href: "/atelier-uwa-architects-sponsoring-the-3rd-british-beacon-mosque-awards-2020/", meta: "2020 sponsor" },
  { title: "3rd British Beacon Mosque Awards Judges Panel", href: "/3rd-british-beacon-mosque-awards-judges-panel/", meta: "2020 judges" },
];

const awardRecognitionProfiles2020 = [
  { title: "MKSI Leicester - Shortlisted Best Run Mosque 2020", href: "/mksi-leicester-shortlisted-best-run-mosque/", category: "Best Run Mosque" },
  { title: "ASCC - Shortlisted Best Run Mosque 2020", href: "/ascc-shortlisted-best-run-mosque/", category: "Best Run Mosque" },
  { title: "Minhaj Ul Quran - Shortlisted Best Run Mosque", href: "/minhaj-ul-quran-shortlisted-best-run-mosque/", category: "Best Run Mosque" },
  { title: "Green Lane Masjid - Shortlisted Best Run Mosque 2020", href: "/green-lane-mosque-shortlisted-best-run-mosque/", category: "Best Run Mosque" },
  { title: "Al Madina Mosque Barking London - Shortlisted Best Run Mosque 2020", href: "/al-madina-mosque-shortlisted-best-run-mosque-2/", category: "Best Run Mosque" },
  { title: "Shortlisted Best Youth Service - Hayes Muslim Centre", href: "/shortlisted-best-youth-service-hayes-muslim-centre/", category: "Best Youth Service" },
  { title: "Khizra Mosque - Shortlisted Best Youth Service", href: "/khizra-mosque-shortlisted-best-youth-service/", category: "Best Youth Service" },
  { title: "3 Meem Foundation - Shortlisted Best Youth Service", href: "/3-meem-foundation-shortlisted-best-youth-service/", category: "Best Youth Service" },
  { title: "Bahu Trust - Shortlisted Best Youth Service", href: "/bahu-trust-shortlisted-best-youth-service/", category: "Best Youth Service" },
  { title: "Guidance Hub - Shortlisted Mosque Best Madrassah Service", href: "/guidance-hub-shortlisted-mosque-best-madrassah-service-2/", category: "Best Madrassah Service" },
  { title: "Lantern Academy - Shortlisted Best Madrassah Service 2020", href: "/lantern-academy-shortlisted-best-madrassah-service/", category: "Best Madrassah Service" },
  { title: "Al Hira - Shortlisted Mosque for Best Madrassah Service 2020", href: "/al-hira-shortlisted-mosque-for-best-madrassah-service/", category: "Best Madrassah Service" },
  { title: "LICS - Shortlisted Mosque for Best Madrassah Service", href: "/lics-shortlisted-mosque-for-best-madrassah-service/", category: "Best Madrassah Service" },
  { title: "Guidance Hub - Shortlisted Mosque Best Madrassah Service 2020", href: "/guidance-hub-shortlisted-mosque-best-madrassah-service/", category: "Best Madrassah Service" },
  { title: "JMIC - Shortlisted Best Women's Service", href: "/jmic-shortlisted-best-womens-service/", category: "Best Women's Service" },
  { title: "ASCC - Shortlisted Best Women's Service", href: "/ascc-shortlisted-best-womens-service/", category: "Best Women's Service" },
  { title: "Guidance Hub - Shortlisted Best Women's Service", href: "/guidance-hub-shortlisted-best-womens-service/", category: "Best Women's Service" },
  { title: "Shortlisted Most Impactful Imam - Shaykh Rizwan", href: "/shortlisted-most-impactful-imam-shaykh-rizwan/", category: "Most Impactful Imam" },
  { title: "Shaykh Aslam - Shortlisted Most Impactful Imam", href: "/shaykh-aslam-shortlisted-most-impactful-imam/", category: "Most Impactful Imam" },
  { title: "Imam Ijaz Shami - Shortlisted Most Impactful Imam", href: "/imam-ijaz-shami-shortlisted-most-impactful-imam/", category: "Most Impactful Imam" },
  { title: "Shaykh Mansoor - Shortlisted Most Impactful Imam", href: "/shaykh-mansoor-shortlisted-most-impactful-imam/", category: "Most Impactful Imam" },
  { title: "Shaykh Rafiq Sufi - Shortlisted Most Impactful Imam", href: "/shaykh-rafiq-sufi-shortlisted-most-impactful-imam/", category: "Most Impactful Imam" },
  { title: "Shaykh Mufti Razza - Shortlisted Most Impactful Imam", href: "/shaykh-mufti-razza-shortlisted-most-impactful-imam/", category: "Most Impactful Imam" },
  { title: "Ustadah Sidra Ahmed - Shortlisted Most Impactful Alimah", href: "/ustadah-sidra-ahmed-shortlisted-most-impactful-alimah/", category: "Most Impactful Alimah" },
  { title: "Ustadah Rukhia Bi - Most Impactful Alimah", href: "/ustadah-rukhia-bi-most-impactful-alimah/", category: "Most Impactful Alimah" },
  { title: "Noshin Gul - Most Impactful Alimah", href: "/noshin-gul-most-impactful-alimah/", category: "Most Impactful Alimah" },
  { title: "Maidenhead Mosque - Shortlisted Best Outreach Programme", href: "/maidenhead-mosque-shortlisted-best-outreach-programme/", category: "Best Outreach Service" },
  { title: "Bahu Trust - Shortlisted Best Outreach Service", href: "/bahu-trust-shortlisted-best-outreach-service/", category: "Best Outreach Service" },
  { title: "Masjid Al Falaah - Shortlisted Best Outreach Programme", href: "/masjid-al-falaah-shortlisted-best-outreach-programme/", category: "Best Outreach Service" },
  { title: "WISE Mosque - Shortlisted Best Elderly Service", href: "/wise-mosque-shortlisted-best-elderly-service/", category: "Best Elderly Service" },
  { title: "Worthing Mosque - Shortlisted Best Elderly Service", href: "/worthing-mosque-shortlisted-best-elderly-service/", category: "Best Elderly Service" },
  { title: "Glasgow Mosque - Shortlisted Best Elderly Service", href: "/glasgow-mosque-shortlisted-best-elderly-service/", category: "Best Elderly Service" },
  { title: "York Mosque - Shortlisted Best Green Initiative", href: "/york-mosque-shortlisted-best-green-initiative/", category: "Best Green Initiative" },
  { title: "Khizra Mosque - Best Green Initiative Shortlist", href: "/khizra-mosque-best-green-initiative-shortlist/", category: "Best Green Initiative" },
  { title: "Al Madina Mosque - Shortlisted Best Green Initiative", href: "/al-madina-mosque-shortlisted-best-green-initiative/", category: "Best Green Initiative" },
  { title: "Al Markaz Ul Islami - Shortlisted Most Innovative Service", href: "/al-markaz-ul-islami-shortlisted-most-innovative-service/", category: "Most Innovative Service" },
  { title: "Khizra Mosque - Shortlisted Most Innovative Service", href: "/khizra-mosque-shortlisted-most-innovative-service/", category: "Most Innovative Service" },
  { title: "Woking Mosque - Shortlisted COVID Response", href: "/woking-mosque-shortlisted-covid-response/", category: "Best Mosque COVID-19 Response" },
  { title: "Masjid Al Falaah - COVID Response", href: "/masjid-al-falaah-covid-response/", category: "Best Mosque COVID-19 Response" },
  { title: "East London Mosque - Shortlisted COVID Response", href: "/east-london-mosque-shortlisted-covid-response/", category: "Best Mosque COVID-19 Response" },
  { title: "Finsbury Park Mosque - Best COVID-19 Response", href: "/finsbury-park-mosque-covid-response/", category: "Best Mosque COVID-19 Response" },
  { title: "Green Lane Mosque - COVID Response 2020", href: "/green-lane-mosque-covid-response/", category: "Best Mosque COVID-19 Response" },
].map((profile) => ({
  ...profile,
  status: "Shortlisted",
...
const awardRecognitionCards2020: CardLink[] = awardRecognitionProfiles2020.map((profile) => ({
  title: profile.title,
  text: profile.summary,
  href: profile.href,
  meta: profile.status,
...
const awardProgrammeCards2020: CardLink[] = awardProgrammePages2020.map((page) => ({
  title: page.title,
...
const awardStoryPages2019 = [
  {
    title: "Turkey President Tayyip Erdogan attends opening of 2019 Beacon Mosque Winner in Cambridge",
    href: "/blog/turkey-president-tayyip-erdogan-attends-opening-of-2019-beacon-mosque-winner-in-cambridge/",
    summary: "A 2019 Beacon Mosque winner story connected to the opening of Cambridge Central Mosque.",
    meta: "2019 winner story",
  },
  {
    title: "1000 registered to attend Mosque Expo & 2nd Beacon Mosque Awards 2019",
    href: "/blog/1000-registered-to-attend-mosque-expo-2nd-beacon-mosque-awards-2019/",
    summary: "A programme story for Mosque Expo and the second British Beacon Mosque Awards in 2019.",
    meta: "2019 programme",
  },
  {
    ...
    summary: "A recognition story following Mevlana Rumi Mosque's journey as one of the early Beacon Mosque award recipients.",
    meta: "Beacon mosque story",
  },
  {
    title: "First Mosques in the UK awarded Beacon Mosque awarded plaques of excellence",
    href: "/uncategorized/first-mosques-in-the-uk-awarded-beacon-mosque-awarded-plaques-of-excellence/",
    summary: "A historic recognition story about the first mosques receiving Beacon Mosque plaques of excellence.",
...
const awardStoryPages2018 = [
  {
    title: "Wessex Jamat - Al Mahdi Centre nominated for Best Green Initiative at 2018 Beacon Mosque Awards",
    href: "/uncategorized/wessex-jamat-al-mahdi-centre-nominated-for-best-green-initiative-at-2018-beacon-mosque-awards/",
    summary: "A founding-year nomination story in the 2018 Best Green Initiative category.",
    meta: "2018 nomination",
  },
  {
    title: "Mevlana Rumi Mosque wins Best Charity Project at 2018 British Beacon Mosque Awards",
    href: "/blog/mevlana-rumi-mosque-wins-best-charity-project-at-2018-british-beacon-mosque-awards/",
    summary: "A 2018 winner story recognising Mevlana Rumi Mosque in the Best Charity Project category.",
    meta: "2018 winner",
  },
  {
    title: "Green Lane Mosque Nominated for Best Charity Project at 2018 Beacon Mosque Awards",
  ...
  {
    title: "Al Madina Mosque Nominated For Best Charity Project at 2018 British Beacon Mosque Awards",
    href: "/blog/al-madina-mosque-nominated-for-best-charity-project-at-2018-british-beacon-mosque-awards/",
    summary: "A 2018 nomination story recognising Al Madina Mosque's charity work.",
    meta: "2018 nomination",
  },
  {
    title: "Wirral Deen Centre Nominated For Best Innovative Service at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Khizra Mosque nominated for best Innovative Service at Beacon Mosque Awards 2018",
    href: "/blog/khizra-mosque-nominated-for-best-innovative-service-at-beacon-mosque-awards-2018/",
    summary: "A 2018 nomination story recognising Khizra Mosque's innovative service work.",
    meta: "2018 nomination",
  },
  {
    title: "Madina institute win Best Innovative Service at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Rumi Mosque wins Best Charity Project at 2018 British Beacon Mosque Awards",
    href: "/blog/rumi-mosque-wins-best-charity-project-at-2018-british-beacon-mosque-awards/",
    summary: "A 2018 winner story recognising Rumi Mosque in the Best Charity Project category.",
    meta: "2018 winner",
  },
  {
    title: "Sultan Bahu Trust win Best Green Initiative at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Wessex Jamaat wins Most Impactful Imam at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Khizra Mosque wins Best Womens Service at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Finsbury Park wins Best Outreach Service at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Hayes Muslim Centre win Best Elderly Service at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Rumi Mosque wins Best Madrassah Service at 2018 British Beacon Mosque Awards",
  ...
  {
    title: "Al Madina Mosque wins Best Youth Service 2018 at Beacon Mosque Awards",
  ...
  {
    title: "Al Manaar wins Britain's Best Run Mosque at 2018 British Beacon Mosque Awards",
...
const awardCategoryPages2018 = [
  {
    ...
    summary: "Youth provision recognised in the first British Beacon Mosque Awards cycle.",
  },
  {
    title: "Best Madrassah Service",
    href: "/best-madrassah-project/",
    keywords: ["Best Madrassah Service", "Madrassah"],
    summary: "Madrassah teaching, learning and pastoral service from the founding awards year.",
  },
  {
    title: "Best Elderly Service",
    href: "/best-elderly-service/",
    keywords: ["Best Elderly Service"],
    summary: "Recognition for mosque support, dignity and care for older community members.",
  },
  {
    title: "Best Outreach Service",
    href: "/best-outrech-programme/",
    keywords: ["Best Outreach Service", "Outreach"],
    summary: "Outreach and public-facing service recognised in the 2018 awards archive.",
  },
  {
    title: "Best Women's Service",
    href: "/best-womens-service/",
    keywords: ["Best Womens Service", "Best Women's Service", "Women's Service"],
    summary: "Women's provision and community service from the first Beacon Mosque Awards.",
  },
  {
    title: "Most Impactful Imam",
    href: "/most-impactful-imam/",
    keywords: ["Most Impactful Imam"],
    summary: "Leadership, scholarship and community impact recognised in the 2018 awards cycle.",
  },
  {
    title: "Best Green Initiative",
    href: "/best-green-initiative/",
    keywords: ["Best Green Initiative"],
    summary: "Environmental responsibility and sustainability initiatives from the founding year.",
  },
  {
    title: "Best Charity Project",
    href: "/best-charity-project/",
    keywords: ["Best Charity Project"],
    summary: "Charitable service and practical community support recognised in 2018.",
  },
  {
    title: "Most Innovative Service",
    href: "/most-innovative-service/",
    keywords: ["Best Innovative Service", "Most Innovative Service", "Innovative Service"],
    summary: "Creative service models and new approaches from the first awards cycle.",
  },
];

const awardCategoryCards2018: CardLink[] = awardCategoryPages2018.map((category) => ({
  title: category.title,
    ...
    year === "2024"
      ...
      : year === "2023"
        ...
        : year === "2022"
          ...
          : year === "2021"
            ? [...awardCategoryPages2021.map((category) => category.title), "Best Future Design"]
            : year === "2020"
...
const awardsArchiveYears = [
  { year: "2025", sequence: "8th", href: "/awards/beacon-mosque-awards-2025/", text: "Official 2025 awards archive with booklet access and the award categories recognised at the ceremony." },
  { year: "2024", sequence: "7th", href: "/awards/awards2024/", text: "Historic 2024 archive for the seventh Beacon Mosque Awards cycle." },
  { year: "2023", sequence: "6th", href: "/awards/awards2023/", text: "Historic 2023 archive for the sixth Beacon Mosque Awards cycle." },
  { year: "2022", sequence: "5th", href: "/awards/british-beacon-mosque-awards-2022/", text: "Historic 2022 archive for the fifth Beacon Mosque Awards cycle." },
  { year: "2021", sequence: "4th", href: "/british-beacon-mosque-awards-2021/", text: "Historic 2021 archive for the fourth Beacon Mosque Awards cycle." },
  { year: "2020", sequence: "3rd", href: "/2020-british-beacon-mosque-awards/", text: "Historic 2020 archive for the third Beacon Mosque Awards cycle." },
  { year: "2019", sequence: "2nd", href: "/awards/2019-british-beacon-mosque-awards/", text: "Historic 2019 archive for the second Beacon Mosque Awards cycle." },
  { year: "2018", sequence: "1st", href: "/awards/2018-british-beacon-mosque-awards/", text: "Founding 2018 archive marking the first British Beacon Mosque Awards cycle." },
];

const awardArchiveHrefByYear = Object.fromEntries(awardsArchiveYears.map(({ year, href }) => [year, href]));

const awardsArchive: CardLink[] = awardsArchiveYears.map(({ year, sequence, href, text }) => ({
...
> = {
  "2024": {
    sequence: "7th",
    intro: "The 7th Beacon Mosque Awards 2024 archive preserves a completed awards cycle celebrating mosque excellence across the UK.",
    paragraphs: [
  ...
  "2023": {
    sequence: "6th",
    intro: "The 6th Beacon Mosque Awards 2023 archive records a landmark awards year for mosque leadership, service and future design.",
    paragraphs: [
  ...
  "2022": {
    sequence: "5th",
    intro: "The 5th Beacon Mosque Awards 2022 archive preserves the fifth annual celebration of excellent mosque service.",
    paragraphs: [
  ...
  "2021": {
    sequence: "4th",
    intro: "The 4th Beacon Mosque Awards 2021 archive preserves a year of recognition for mosques and community leaders.",
    paragraphs: [
  ...
  "2020": {
    sequence: "3rd",
    intro: "The 3rd Beacon Mosque Awards 2020 archive preserves an important awards cycle in the programme's early national growth.",
    paragraphs: [
  ...
  "2019": {
    sequence: "2nd",
    intro: "The 2nd Beacon Mosque Awards 2019 archive preserves the second annual awards cycle after the programme's launch.",
    paragraphs: [
  ...
  "2018": {
    sequence: "1st",
    intro: "The 1st Beacon Mosque Awards 2018 archive marks the founding year of the British Beacon Mosque Awards.",
    paragraphs: [
...
const mosqueResourceArticles: ReferenceArticle[] = [
  {
    ...
    summary: "A long-range plan for mosques that looks toward spiritually grounded, safe and sustainable community institutions.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "Guidance for improving women's participation in mosque governance, management and service delivery.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "A practical guide for mosques hosting open days, welcoming visitors and building stronger local relationships.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "A governance and operations guide for mosque trustees, managers, imams, staff and volunteers.",
    paragraphs: [
...
const mosqueResourceCards: CardLink[] = mosqueResourceArticles.map((article) => ({
  title: article.title,
...
> = {
  "standards/community-development": {
    intro: "A Beacon Mosque nurtures strong communities, families and neighbourhood relationships beyond ritual worship.",
    summary: [
  ...
  "standards/accountability-and-transparency": {
    intro: "A Beacon Mosque is answerable to Allah, its congregation, its donors, its regulators and the wider community.",
    summary: [
  ...
  "standards/additional-services": {
    intro: "A Beacon Mosque extends beyond core prayer facilities by offering services that meet the needs of its community.",
    summary: [
  ...
  "standards/madrassah": {
    intro: "A Beacon Mosque supports a madrassah or supplementary school that provides safe, structured Islamic education.",
    summary: [
  ...
  "standards/communication": {
    intro: "A Beacon Mosque communicates clearly with worshippers, neighbours, media partners and the wider public.",
    summary: [
  ...
  "standards/management-governance": {
    intro: "A Beacon Mosque has a clear vision, responsible governance and management structures that support long-term trust.",
    summary: [
  ...
  "standards/policies-procedures": {
    intro: "A Beacon Mosque uses clear policies and procedures to guide safe, lawful and consistent practice.",
    summary: [
  ...
  "standards/facilities-management": {
    intro: "A Beacon Mosque provides facilities that are safe, user-friendly and suitable for worshippers and community users.",
    summary: [
  ...
  "standards/staffing-employment": {
    intro: "A Beacon Mosque appoints, supports and manages staff and volunteers fairly and responsibly.",
    summary: [
  ...
  "standards/financing-fundraising": {
    intro: "A Beacon Mosque manages finances and fundraising with planning, transparency and accountability.",
    summary: [
...
> = {
  "burhan-centre-madrassah-triumphs-in-the-eman-cup-2024-at-lords": {
    intro: "Burhan Centre Madrassah from Manchester won the EMAN Cup 2024 after a national inter-madrassah cricket tournament culminating at Lord's.",
    paragraphs: [
  ...
  "fattah-cup-inter-madrassah-football-tournament": {
    intro: "The Fattah Cup Inter-Madrassah Football Tournament brought together young players, mosques and community volunteers across London.",
    paragraphs: [
  ...
  "news/birmingham-mosque-wins-beacon-best-future-design-award": {
    intro: "A Birmingham mosque won the Beacon Best Future Design Award at the 6th Annual British Beacon Mosque Awards 2023.",
    paragraphs: [
  ...
  "british-beacon-mosque-awards-2021-finalists-named-in-the-queens-honours-list": {
    intro: "An archive recognition item from the Beacon Mosque news listing celebrating British Beacon Mosque Awards 2021 finalists named in the Queen's Honours List.",
    paragraphs: [
...
const referenceNewsArticles: ReferenceArticle[] = [
  {
    ...
    summary: "A Blackburn mosque bereavement team was recognised for compassionate volunteer service to families and the wider community.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "Easton Mosque was recognised nationally for facilities and services that improved space for women.",
    paragraphs: [
  ...
  {
    title: "British Beacon Mosque Awards 2021 Finalists Named in the Queen's Honours",
    href: "/news/british-beacon-mosque-awards-2021-finalists-named-in-the-queens-honours/",
    meta: "National honours",
    summary: "A recognition story connecting Beacon Mosque Awards finalists with national civic honours.",
    paragraphs: [
  ...
  },
  {
    ...
    meta: "Awards 2021",
    summary: "Mosques across the UK were recognised through the 2021 Beacon Mosque Awards for leadership, service and community impact.",
    paragraphs: [
  ...
  {
    title: "Winners of the British Beacon Mosque Awards 2020 Celebrate with their Trophies",
    href: "/news/winners-of-the-british-beacon-mosque-awards-2020-celebrate-with-their-trophies/",
    meta: "Awards 2020",
    summary: "British Beacon Mosque Awards 2020 winners celebrated their trophies after a year of recognised service.",
    paragraphs: [
  ...
  {
    title: "Caring Schoolgirl Raises More Than £10,000 to Help Injured Children in Hospital",
    href: "/news/caring-schoolgirl-raises-more-than-10000-to-help-injured-children-in-hospital/",
    meta: "Community fundraising",
    summary: "A community fundraising story highlighting care for injured children and the generosity of young people.",
    paragraphs: [
  ...
  },
  {
    ...
    meta: "Food support",
    summary: "Worthing Mosque supported elderly residents by donating grocery boxes during a period of community need.",
    paragraphs: [
  ...
  {
    title: "Cambridge Central Mosque Brings Touch of Goodwill to Help Royal Papworth Hospital Staff on Coronavirus Frontline",
    ...
    summary: "Cambridge Central Mosque supported Royal Papworth Hospital staff during the coronavirus frontline response.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "Mosque and council leaders praised voluntary heroes in Oldham for their community support work.",
    paragraphs: [
  ...
  },
  {
    ...
    meta: "Food packs",
    summary: "Park Road Mosque in Banbury provided food packs for people in the local community.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "Sikh volunteers supported Jama Masjid by helping sanitise the mosque during a public health response.",
    paragraphs: [
  ...
  {
    title: "Royal Couple Visits Shah Jahan Mosque in Woking to Pack Emergency Food Parcels",
    href: "/news/royal-couple-visits-shah-jahan-mosque-in-woking-to-pack-emergency-food-parcels/",
    meta: "Emergency parcels",
    summary: "The Shah Jahan Mosque in Woking hosted a royal visit connected to emergency food parcel support.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "A fundraising story about raising support to build Seville's first mosque in centuries.",
    paragraphs: [
  ...
  {
    title: "Volunteer Helps Save Life of Man She'd Been Delivering Food to During Lockdown",
    href: "/news/volunteer-helps-save-life-of-man-shed-been-delivering-food-to-during-lockdown/",
    meta: "Lockdown support",
    summary: "A lockdown volunteer helped save the life of someone she had been delivering food to.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "A mosque donation helped fund PPE for a Huddersfield hospice during a period of health-sector pressure.",
    paragraphs: [
  ...
  {
    title: "More Than 350 Families Helped by Woking Mosque Volunteers During Coronavirus Crisis",
    href: "/news/more-than-350-families-helped-by-woking-mosque-volunteers-during-coronavirus-crisis/",
    meta: "Coronavirus response",
    summary: "Woking mosque volunteers helped more than 350 families during the coronavirus crisis.",
    paragraphs: [
  ...
  },
  {
    ...
    meta: "Local support",
    summary: "Cambridge Central Mosque supported local residents through community help and practical outreach.",
    paragraphs: [
  ...
  {
    title: "We Want to Build a Community Bridge: Norwich Mosque Throws Open its Doors to the Public",
    href: "/news/we-want-to-build-a-community-bridge-norwich-mosque-throws-open-its-doors-to-the-public/",
    meta: "Open mosque",
    summary: "A Norwich mosque opened its doors to the public to build stronger community relationships.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "York Mosque supported people experiencing homelessness through practical community help.",
    paragraphs: [
...
const referenceBlogArticles: ReferenceArticle[] = [
  {
    title: "Beacon Mosques and UK Council of Mosques Launch Guidance on Coronavirus",
    href: "/blog/beacon-mosques-uk-council-of-mosques-come-together-to-launch-guidance-on-coronavirus/",
    meta: "Coronavirus guidance",
    summary: "Beacon Mosques and the UK Council of Mosques came together to share guidance during the coronavirus response.",
    paragraphs: [
  ...
  },
  {
    ...
    summary: "A public health update from the archive about mosque closures in France during the spread of coronavirus.",
    paragraphs: [
...
const communityStoryCards: CardLink[] = [...newsCards, ...referenceNewsCards, ...referenceBlogCards];
...
> = {
  "rumi-mosque-four-star-accredited-mosque": {
    ...
    intro: "Mevlana Rumi Mosque is one of the first recognised Beacon Mosques and has achieved four-star certified Beacon Mosque Accreditation.",
    paragraphs: [
    ...
    groups: [
      {
        title: "Accreditation",
        items: ["Four-star Beacon Mosque accreditation.", "Recognised as one of the first Beacon Mosques.", "Awarded an official accreditation plaque by Faith Associates."],
      },
      {
        title: "Community services",
        items: ["Support for people in need.", "Outreach programmes for the wider community.", "Education facilities and youth sports provision."],
      },
      {
        title: "Awards recognition",
        items: ["Best charity work recognition.", "Best madrassah service recognition.", "British Beacon Mosque Awards 2018 winner."],
      },
    ],
  },
  "al-manaar-mosque-five-star-accredited": {
    rating: "Five Star Accredited",
    intro: "Al Manaar Islamic Centre is one of the first recognised Beacon Mosques and has achieved five-star certified Beacon Mosque Accreditation.",
    paragraphs: [
    ...
    groups: [
      {
        title: "Accreditation",
        items: ["Five-star Beacon Mosque accreditation.", "Official accreditation plaque awarded by Faith Associates.", "Recognised as one of the first Beacon Mosques."],
      },
      {
        title: "Community services",
        items: ["Homeless shelter provision.", "Outreach programmes and youth sports facilities.", "Grenfell disaster emergency response and ongoing support."],
      },
      {
        title: "Awards recognition",
        items: ["Best Run Mosque award winner at the 2018 British Beacon Mosque Awards.", "Recognised for community leadership and service.", "Hosted interfaith and community engagement initiatives."],
      },
    ],
  },
  "al-madina-mosque-barking-five-star-accredited": {
    rating: "Five Star Accredited",
    intro: "Al Madina Mosque Barking is one of the first recognised Beacon Mosques and has achieved five-star certified Beacon Mosque Accreditation.",
    paragraphs: [
    ...
    groups: [
      {
        title: "Accreditation",
        items: ["Five-star Beacon Mosque accreditation.", "Recognised as one of the first Beacon Mosques.", "Awarded an official accreditation plaque by Faith Associates."],
      },
      {
        title: "Community services",
        items: ["Support for the less fortunate.", "Outreach programmes for local communities.", "Sports facilities and youth-focused provision."],
      },
      {
        title: "Awards recognition",
        items: ["Best Youth Service 2018 winner.", "British Beacon Mosque Awards recognition.", "Recognised for service to young people and the wider community."],
      },
    ],
  },
};
...
const pageMap: Record<string, InteriorPage> = {
  "about-us": {
    ...
    eyebrow: "About us",
    intro: "Improve the status of your Mosque by achieving the Beacon Mosque Standards.",
    image: "/assets/interior/about-hero.jpg",
    imageAlt: "Beacon Mosque interior architectural detail",
    ctas: [
      { label: "Email Beacon Mosque", href: "/contact-us/" },
      { label: "See our 10 Standards", href: "/standards/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
  ...
  awards: {
    ...
    eyebrow: "Awards",
    intro: "The 9th annual Beacon Mosque Awards will be held in November 2026, awarding and recognising the amazing efforts of Mosques across the UK.",
    heroVideo: "https://beaconmosque.com/wp-content/uploads/2026/03/WhatsApp-Video-2026-03-05-at-12.31.47.mp4",
    heroVideoPoster: "/assets/interior/awards-gala.jpg",
    ctas: [{ label: "Submit Your Nomination for the 9th Beacon Mosque Awards 2026", href: "/awards/beacon-mosque-awards-2026/" }],
    sections: [
  ...
  "awards/beacon-mosque-awards-2026": {
    ...
    intro: "The 9th Annual Beacon Mosque Awards Ceremony & Gala Dinner returns this November 2026 and nominations are now open.",
    image: "/assets/hero/awards-2025-poster.jpeg",
    imageAlt: "British Beacon Mosque Awards programme artwork",
    ctas: [{ label: "Submit your nomination", href: "#nomination-form" }],
    sections: [
      {
        kind: "text",
        paragraphs: [
          "This prestigious event celebrates excellence across Mosques, Madrassahs, Imams, Alimahs and volunteers, recognising outstanding contributions across 10 categories.",
          "Winners are selected by independent judges from a shortlist of finalists, ensuring a fair and credible process that the community can trust.",
          "Know a Mosque going above and beyond, an Imam making a real difference, or a volunteer whose dedication deserves recognition? This is the moment to put them forward.",
          "Submit your nomination today and help shine a light on the people and institutions shaping our communities for the better.",
          awardProgrammeFunding,
        ],
      },
      { kind: "cards", title: "Nominate Across Our 10 Award Categories for 2026", cards: awardCategoryCards },
      {
        kind: "form",
        form: "nomination",
  ...
  nominate: {
    ...
    eyebrow: "Nominations",
    intro: "Submit a mosque, madrassah, imam, alimah or volunteer for consideration by the Beacon Mosque Awards team.",
    image: "/assets/hero/awards-2025-poster.jpeg",
    imageAlt: "British Beacon Mosque Awards programme artwork",
    ctas: [
      { label: "View Awards 2026", href: "/awards/beacon-mosque-awards-2026/" },
      { label: "Explore award categories", href: "/awards/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
  ...
  "awards/beacon-mosque-awards-2025": {
    ...
    intro: "The 8th Annual Beacon Mosque Awards 2025 recognised Mosques, Madrassahs, Imams, Alimahs and volunteers across 10 categories.",
    image: "/assets/awards/bbma-2025.jpg",
    imageAlt: "British Beacon Mosque Awards 2025 identity",
    ctas: [{ label: "Download booklet", href: "/wp-content/uploads/2025/11/Booklet-British-Beacon-Mosque-Awards-2025a-1.pdf" }],
    sections: [
      {
        kind: "text",
      ...
      { kind: "cards", title: "Award categories recognised in 2025", cards: awardCategoryCardsForYear("2025") },
      { kind: "cards", title: "2025 winner and finalist profiles", cards: awardRecognitionCards2025 },
      { kind: "cards", title: "More award years", cards: awardsArchive.filter((card) => card.href !== "/awards/beacon-mosque-awards-2025/") },
    ],
  },
  standards: {
    slug: "standards",
    ...
    eyebrow: "Standards",
    intro: "Beacon Mosque standards help mosques build excellent governance, safeguarding, facilities, communication and community service.",
    image: "/assets/interior/standards-wide.jpg",
    imageAlt: "Beacon Mosque standards graphic",
    sections: [
      {
  ...
  "accreditation-process": {
    ...
    intro: "The Beacon Mosque initiative gives mosque leadership the ability to rate their Mosque against clear criteria to achieve 3, 4 or 5-star accreditation.",
    ...
    ctas: [
      ...
      { label: "Contact Beacon Mosque", href: "/contact-us/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      },
      {
        ...
        cards: [
          { title: "Enquire", text: "Complete the Rate Your Mosque form or contact Beacon Mosque to begin.", href: "/ratings/", meta: "01" },
          { title: "Audit", text: "The team liaises with the Mosque to assess against the ten Beacon Mosque Standards.", href: "/standards/", meta: "02" },
          { title: "Certification", text: "After the audit, the Mosque is advised of its rating and receives formal certification.", href: "/beacon-mosques/", meta: "03" },
        ],
      },
      { kind: "criteria", title: "Star rating criteria", groups: accreditationCriteria },
    ],
  },
  "beacon-mosques": {
    slug: "beacon-mosques",
    ...
    eyebrow: "Accreditation",
    intro: "Mosques that have been awarded star ratings and are recognised as Beacon Mosques.",
  ...
  ratings: {
    ...
    eyebrow: "Accreditation",
    intro: "Using the Beacon Mosque Accreditation criteria, you can assess whether your Mosque meets the requirements of a 3-star, 4-star or 5-star Beacon Mosque.",
    sections: [
      {
        kind: "text",
        paragraphs: [
      ...
      { kind: "criteria", title: "What the assessment considers", groups: accreditationCriteria },
      { kind: "form", form: "rating", title: "Rate your Mosque", text: "Answer the options that best represent your Mosque." },
    ],
  },
  "mosques-as-resilience-hubs": {
    ...
    intro: "Mosques can serve as trusted community-serving facilities that support residents, coordinate communication, distribute resources and strengthen quality of life.",
    image: "/assets/interior/golden-mosque.jpg",
    imageAlt: "Mosque dome at sunset",
    sections: [
      {
      ...
      { kind: "cards", title: "Three Resilience Hub Modes", cards: resilienceModes },
      {
        kind: "text",
      ...
      { kind: "criteria", title: "Resilience Hub options", groups: resilienceOptionCriteria },
      { kind: "cards", title: "Examples of Mosques as Resilience Hubs", cards: resilienceExamples },
    ],
  },
  resources: {
    slug: "resources",
    ...
    intro: "Beacon Mosque resources support mosque leaders with long-term planning, open days, management, awards information and inclusive leadership.",
    image: "/assets/interior/standards-wide.jpg",
    imageAlt: "Beacon Mosque standards graphic",
    sections: [
      {
  ...
  "category/news": {
    ...
    intro: "Stories from award winners, accredited mosques and national community initiatives.",
    sections: [{ kind: "cards", title: "Latest news", cards: communityStoryCards }],
  },
  gallery: {
    slug: "gallery",
    title: "Our Gallery",
    eyebrow: "Beacon Mosque archive",
    intro: "A visual archive of mosque spaces, community gathering and Beacon Mosque activity.",
  ...
  "contact-us": {
    ...
    ctas: [
      ...
      { label: "Call Beacon Mosque", href: "tel:01494416202", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      { kind: "form", form: "contact", title: "Send a message", text: "Use this form to contact Beacon Mosque." },
    ],
  },
  "privacy-policy": {
    slug: "privacy-policy",
    ...
    eyebrow: "Privacy",
    intro: "Beacon Mosque is committed to protecting and respecting your privacy and complying with GDPR principles.",
    sections: [
      {
        kind: "text",
...
awardCategoryNominations.forEach((category) => {
  ...
  pageMap[slug] = {
    slug,
    title: `${category.title} Nomination 2026`,
    eyebrow: "Awards 2026 nomination",
    intro: `Nominate a mosque, madrassah, imam, alimah or volunteer for the ${category.title} category at the 9th Beacon Mosque Awards 2026.`,
    image: "/assets/hero/awards-2025-poster.jpeg",
    imageAlt: "British Beacon Mosque Awards programme artwork",
    ctas: [
      { label: "Submit nomination", href: "#nomination-form" },
      { label: "View all award categories", href: "/awards/beacon-mosque-awards-2026/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
        title: category.title,
        paragraphs: [
          `Use this page to submit a nomination for the ${category.title} award category.`,
          "Winners are selected by independent judges from shortlisted finalists, helping the awards maintain a fair and credible process.",
        ],
      },
      {
        kind: "form",
        form: "nomination",
        title: `${category.title} nomination details`,
...
awardRecognitionProfiles2025.forEach((profile) => {
  const slug = profile.href.replace(/^\/|\/$/g, "");
  const relatedProfiles = awardRecognitionCards2025
    .filter((card) => card.href !== profile.href)
    .filter((card) => awardRecognitionProfiles2025.find((item) => item.href === card.href)?.category === profile.category)
    .slice(0, 6);
  ...
  pageMap[slug] = {
    ...
    imageAlt: "British Beacon Mosque Awards 2025 identity",
    ctas: [
      { label: "Back to Awards 2025", href: "/awards/beacon-mosque-awards-2025/" },
    ...
    sections: [
      ...
      {
        kind: "cards",
        title: relatedProfiles.length ? `More ${profile.category} profiles` : "More 2025 award profiles",
        cards: relatedProfiles.length ? relatedProfiles : awardRecognitionCards2025.filter((card) => card.href !== profile.href).slice(0, 6),
      },
    ],
  };
});
...
standards.forEach((standard) => {
  ...
  pageMap[slug] = {
    ...
    ctas: [
      ...
      { label: "Start accreditation", href: "/accreditation-process/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
...
[...referenceNewsArticles, ...referenceBlogArticles].forEach((article) => {
  ...
  const relatedStories = communityStoryCards.filter((item) => item.href !== article.href).slice(0, 8);
...
mosqueResourceArticles.forEach((article) => {
  const slug = article.href.replace(/^\/|\/$/g, "");
  const relatedResources = allResourceCards.filter((item) => item.href !== article.href).slice(0, 8);
...
accreditedMosques.forEach((mosque) => {
  ...
  pageMap[slug] = {
    ...
    ctas: [
      ...
      { label: "See all accredited mosques", href: "/beacon-mosques/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
...
awardCategoryPages2025.forEach((category) => {
  const slug = category.href.replace(/^\/|\/$/g, "");
  const categoryProfiles = awardRecognitionCards2025.filter(
    (card) => awardRecognitionProfiles2025.find((profile) => profile.href === card.href)?.category === category.title,
  );
  ...
  pageMap[slug] = {
    ...
    ctas: [
      { label: "Back to Awards 2025", href: "/awards/beacon-mosque-awards-2025/" },
      { label: "Nominate for 2026", href: awardCategoryNominations.find((item) => item.title === category.title)?.href ?? "/awards/beacon-mosque-awards-2026/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
        ...
        paragraphs: [
          ...
          "The 2025 profiles below include winners, finalists and shortlisted mosques or individuals from this category.",
        ],
      },
      {
        kind: "cards",
        ...
        cards: categoryProfiles.length
          ...
          : [
              {
                title: category.title,
                text: "This category formed part of the 2025 Beacon Mosque Awards recognition programme.",
      ...
      {
        kind: "cards",
        title: "Other 2025 categories",
        cards: awardCategoryCardsForYear("2025").filter((card) => card.href !== category.href),
      },
    ],
  };
});
...
awardRecognitionProfiles2024.forEach((profile) => {
  ...
  const relatedProfiles = awardRecognitionCards2024
    .filter((card) => card.href !== profile.href)
    .filter((card) => awardRecognitionProfiles2024.find((item) => item.href === card.href)?.category === profile.category)
    .slice(0, 6);
  ...
  pageMap[slug] = {
    ...
    sections: [
      ...
      {
        kind: "cards",
        title: relatedProfiles.length ? `More ${profile.category} profiles` : "More 2024 award profiles",
        cards: relatedProfiles.length ? relatedProfiles : awardRecognitionCards2024.filter((card) => card.href !== profile.href).slice(0, 6),
      },
    ],
  };
});
...
awardCategoryPages2024.forEach((category) => {
  ...
  const categoryProfiles = awardRecognitionCards2024.filter(
    (card) => awardRecognitionProfiles2024.find((profile) => profile.href === card.href)?.category === category.title,
  );
  ...
  pageMap[slug] = {
    ...
    ctas: [
      { label: "Back to Awards 2024", href: "/awards/awards2024/" },
      { label: "View Awards 2025", href: "/awards/beacon-mosque-awards-2025/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      },
      {
        ...
        cards: awardCategoryCardsForYear("2024").filter((card) => card.href !== category.href),
      },
    ],
  };
});
...
awardCategoryPages2023.forEach((category) => {
  ...
  pageMap[slug] = {
    ...
    ctas: [
      ...
      { label: "View Awards 2024", href: "/awards/awards2024/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      },
      {
        ...
        cards: awardCategoryCardsForYear("2023").filter((card) => card.href !== category.href),
      },
      {
        kind: "cards",
        title: "Continue through the awards archive",
        cards: awardsArchive.filter((card) => card.href !== "/awards/awards2023/").slice(0, 6),
      },
    ],
  };
});
...
awardCategoryPages2022.forEach((category) => {
  ...
  const categoryProfiles = awardRecognitionCards2022.filter(
    (card) => awardRecognitionProfiles2022.find((profile) => profile.href === card.href)?.category === category.title,
  );
  const categoryResources = [...awardFinalistCards2022, ...awardVoteCards2022].filter((card) => {
    const finalist = awardFinalistPages2022.find((page) => page.href === card.href);
  ...
  const page: InteriorPage = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: "Back to Awards 2022", href: "/awards/british-beacon-mosque-awards-2022/" },
      { label: "View Awards 2023", href: "/awards/awards2023/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      {
        kind: "cards",
        title: categoryProfiles.length ? `${category.title} shortlisted profiles` : "2022 category resources",
        cards: categoryProfiles.length
          ? categoryProfiles
          : [
              {
        ...
        : []),
      {
        ...
        cards: awardCategoryCardsForYear("2022").filter((card) => card.href !== category.href),
      },
    ],
  };
...
awardRecognitionProfiles2022.forEach((profile) => {
  ...
  const relatedProfiles = awardRecognitionCards2022
    .filter((card) => awardRecognitionProfiles2022.find((item) => item.href === card.href)?.category === profile.category)
    .filter((card) => card.href !== profile.href);
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: `View ${profile.category}`, href: awardCategoryHref2022[profile.category] ?? "/awards/british-beacon-mosque-awards-2022/" },
      { label: "Back to Awards 2022", href: "/awards/british-beacon-mosque-awards-2022/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      {
        kind: "cards",
        title: relatedProfiles.length ? `More ${profile.category} profiles` : "More 2022 award profiles",
        cards: relatedProfiles.length ? relatedProfiles : awardRecognitionCards2022.filter((card) => card.href !== profile.href).slice(0, 6),
      },
    ],
  };
});
...
[...awardFinalistPages2022, ...awardVotePages2022].forEach((summaryPage) => {
  ...
  const categoryProfiles = awardRecognitionCards2022.filter(
    (card) => awardRecognitionProfiles2022.find((profile) => profile.href === card.href)?.category === summaryPage.category,
  );
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: `View ${summaryPage.category}`, href: awardCategoryHref2022[summaryPage.category] ?? "/awards/british-beacon-mosque-awards-2022/" },
      { label: "Back to Awards 2022", href: "/awards/british-beacon-mosque-awards-2022/", variant: "secondary" },
    ],
    sections: [
      {
      ...
      {
        kind: "cards",
        title: categoryProfiles.length ? `${summaryPage.category} shortlisted profiles` : "2022 category",
        cards: categoryProfiles.length
          ? categoryProfiles
          : [
              {
                ...
                href: awardCategoryHref2022[summaryPage.category] ?? "/awards/british-beacon-mosque-awards-2022/",
                meta: "2022 category",
              },
            ],
      },
...
pageMap["beacon-mosque-awards-2022-media-wall"] = {
  ...
  intro: "A historic media wall route from the 2022 Beacon Mosque Awards archive.",
  image: "/assets/interior/awards-gala.jpg",
  imageAlt: "Beacon Mosque awards ceremony",
  ctas: [
    { label: "Back to Awards 2022", href: "/awards/british-beacon-mosque-awards-2022/" },
  ...
  sections: [
    ...
    { kind: "cards", title: "2022 award categories", cards: awardCategoryCardsForYear("2022") },
    { kind: "cards", title: "2022 shortlisted profiles", cards: awardRecognitionCards2022.slice(0, 12) },
  ],
};
...
awardCategoryPages2021.forEach((category) => {
  ...
  const categoryProfiles = awardRecognitionCards2021.filter(
    (card) => awardRecognitionProfiles2021.find((profile) => profile.href === card.href)?.category === category.title,
  );
  const categoryResources = [...awardVoteCards2021, ...awardResultCards2021].filter((card) => {
  ...
  const page: InteriorPage = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: "Back to Awards 2021", href: "/british-beacon-mosque-awards-2021/" },
      { label: "View Awards 2022", href: "/awards/british-beacon-mosque-awards-2022/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      {
        kind: "cards",
        title: categoryProfiles.length ? `${category.title} shortlisted profiles` : "2021 category resources",
        cards: categoryProfiles.length
          ? categoryProfiles
          : [
              {
        ...
        : []),
      {
        ...
        cards: awardCategoryCardsForYear("2021").filter((card) => card.href !== category.href),
      },
    ],
  };
...
awardRecognitionProfiles2021.forEach((profile) => {
  ...
  const relatedProfiles = awardRecognitionCards2021
    .filter((card) => awardRecognitionProfiles2021.find((item) => item.href === card.href)?.category === profile.category)
    .filter((card) => card.href !== profile.href);
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: `View ${profile.category}`, href: awardCategoryHref2021[profile.category] ?? "/british-beacon-mosque-awards-2021/" },
      { label: "Back to Awards 2021", href: "/british-beacon-mosque-awards-2021/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      {
        kind: "cards",
        title: relatedProfiles.length ? `More ${profile.category} profiles` : "More 2021 award profiles",
        cards: relatedProfiles.length ? relatedProfiles : awardRecognitionCards2021.filter((card) => card.href !== profile.href).slice(0, 6),
      },
    ],
  };
});
...
[...awardVotePages2021, ...awardResultPages2021].forEach((summaryPage) => {
  const slug = summaryPage.href.replace(/^\/|\/$/g, "");
  const categoryProfiles = awardRecognitionCards2021.filter(
    (card) => awardRecognitionProfiles2021.find((profile) => profile.href === card.href)?.category === summaryPage.category,
  );
  const isVotePage = summaryPage.href.includes("-vote/");
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: `View ${summaryPage.category}`, href: awardCategoryHref2021[summaryPage.category] ?? "/british-beacon-mosque-awards-2021/" },
      { label: "Back to Awards 2021", href: "/british-beacon-mosque-awards-2021/", variant: "secondary" },
    ],
    sections: [
      {
      ...
      {
        kind: "cards",
        title: categoryProfiles.length ? `${summaryPage.category} shortlisted profiles` : "2021 category",
        cards: categoryProfiles.length
          ? categoryProfiles
          : [
              {
                ...
                href: awardCategoryHref2021[summaryPage.category] ?? "/british-beacon-mosque-awards-2021/",
                meta: "2021 category",
              },
            ],
      },
...
awardCategoryPages2020.forEach((category) => {
  ...
  const categoryProfiles = awardRecognitionCards2020.filter(
    (card) => awardRecognitionProfiles2020.find((profile) => profile.href === card.href)?.category === category.title,
  );
  const categoryResources = awardVoteCards2020.filter((card) => awardVotePages2020.find((page) => page.href === card.href)?.category === category.title);
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: "Back to Awards 2020", href: "/2020-british-beacon-mosque-awards/" },
      { label: "View Awards 2021", href: "/british-beacon-mosque-awards-2021/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      {
        kind: "cards",
        title: categoryProfiles.length ? `${category.title} shortlisted profiles` : "2020 category resources",
        cards: categoryProfiles.length
          ? categoryProfiles
          : [
              {
        ...
        : []),
      {
        ...
        cards: awardCategoryCardsForYear("2020").filter((card) => card.href !== category.href),
      },
    ],
  };
});
...
awardRecognitionProfiles2020.forEach((profile) => {
  ...
  const relatedProfiles = awardRecognitionCards2020
    .filter((card) => awardRecognitionProfiles2020.find((item) => item.href === card.href)?.category === profile.category)
    .filter((card) => card.href !== profile.href);
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: `View ${profile.category}`, href: awardCategoryHref2020[profile.category] ?? "/2020-british-beacon-mosque-awards/" },
      { label: "Back to Awards 2020", href: "/2020-british-beacon-mosque-awards/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      {
        kind: "cards",
        title: relatedProfiles.length ? `More ${profile.category} profiles` : "More 2020 award profiles",
        cards: relatedProfiles.length ? relatedProfiles : awardRecognitionCards2020.filter((card) => card.href !== profile.href).slice(0, 6),
      },
    ],
  };
});
...
awardVotePages2020.forEach((summaryPage) => {
  const slug = summaryPage.href.replace(/^\/|\/$/g, "");
  const categoryProfiles = awardRecognitionCards2020.filter(
    (card) => awardRecognitionProfiles2020.find((profile) => profile.href === card.href)?.category === summaryPage.category,
  );
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: `View ${summaryPage.category}`, href: awardCategoryHref2020[summaryPage.category] ?? "/2020-british-beacon-mosque-awards/" },
      { label: "Back to Awards 2020", href: "/2020-british-beacon-mosque-awards/", variant: "secondary" },
    ],
    sections: [
      {
      ...
      {
        kind: "cards",
        title: categoryProfiles.length ? `${summaryPage.category} shortlisted profiles` : "2020 category",
        cards: categoryProfiles.length
          ? categoryProfiles
          : [
              {
                ...
                href: awardCategoryHref2020[summaryPage.category] ?? "/2020-british-beacon-mosque-awards/",
                meta: "2020 category",
              },
            ],
      },
...
awardProgrammePages2020.forEach((programmePage) => {
  ...
  pageMap[slug] = {
    ...
    sections: [
      ...
      { kind: "cards", title: "2020 award categories", cards: awardCategoryCardsForYear("2020") },
    ],
  };
});
...
awardStoryPages2019.forEach((story) => {
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: "Back to Awards 2019", href: "/awards/2019-british-beacon-mosque-awards/" },
      { label: "View Awards Archive", href: "/awards/", variant: "secondary" },
    ],
    sections: [
      {
      ...
      { kind: "cards", title: "More 2019 awards stories", cards: awardStoryCards2019.filter((card) => card.href !== story.href) },
      { kind: "cards", title: "Continue through the awards archive", cards: awardsArchive.filter((card) => card.href !== "/awards/2019-british-beacon-mosque-awards/").slice(0, 6) },
    ],
  };
});
...
awardStoryPages2018.forEach((story) => {
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: "Back to Awards 2018", href: "/awards/2018-british-beacon-mosque-awards/" },
      { label: "View Awards Archive", href: "/awards/", variant: "secondary" },
    ],
    sections: [
      {
      ...
      { kind: "cards", title: "More 2018 awards stories", cards: awardStoryCards2018.filter((card) => card.href !== story.href).slice(0, 8) },
      { kind: "cards", title: "Continue through the awards archive", cards: awardsArchive.filter((card) => card.href !== "/awards/2018-british-beacon-mosque-awards/").slice(0, 6) },
    ],
  };
});
...
awardCategoryPages2018.forEach((category) => {
  const slug = category.href.replace(/^\/|\/$/g, "");
  const searchText = (card: CardLink) => `${card.title} ${card.text}`.toLowerCase();
  const categoryStories = awardStoryCards2018.filter((card) =>
    category.keywords.some((keyword) => searchText(card).includes(keyword.toLowerCase()))
  );
  ...
  pageMap[slug] = {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: categoryStories.length ? categoryStories : awardStoryCards2018.slice(0, 6),
      },
      {
        kind: "cards",
        title: "Other 2018 categories",
        cards: awardCategoryCards2018.filter((card) => card.href !== category.href),
      },
    ],
  };
});
...
for (const [year, detail] of Object.entries(historicAwardArchiveDetails)) {
  const primarySlug = (awardArchiveHrefByYear[year] ?? `/awards/beacon-mosque-awards-${year}/`).replace(/^\/|\/$/g, "");
  const archivePage: InteriorPage = {
    ...
    sections: [
      ...
      { kind: "cards", title: `Award categories recognised in ${year}`, cards: awardCategoryCardsForYear(year) },
      ...(year === "2024" ? [{ kind: "cards" as const, title: "2024 shortlisted profiles", cards: awardRecognitionCards2024 }] : []),
      ...(year === "2022"
        ? [
            {
              kind: "cards" as const,
            ...
            { kind: "cards" as const, title: "2022 finalist and voting pages", cards: [...awardFinalistCards2022, ...awardVoteCards2022] },
            { kind: "cards" as const, title: "2022 shortlisted profiles", cards: awardRecognitionCards2022 },
          ]
        : []),
      ...(year === "2021"
        ? [
            { kind: "cards" as const, title: "2021 voting and results pages", cards: [...awardVoteCards2021, ...awardResultCards2021] },
            { kind: "cards" as const, title: "2021 shortlisted profiles", cards: awardRecognitionCards2021 },
          ]
        : []),
      ...(year === "2020"
        ? [
            { kind: "cards" as const, title: "2020 programme pages", cards: awardProgrammeCards2020 },
            { kind: "cards" as const, title: "2020 voting pages", cards: awardVoteCards2020 },
            { kind: "cards" as const, title: "2020 shortlisted profiles", cards: awardRecognitionCards2020 },
          ]
        : []),
      ...(year === "2019" ? [{ kind: "cards" as const, title: "2019 awards stories", cards: awardStoryCards2019 }] : []),
      ...(year === "2018" ? [{ kind: "cards" as const, title: "2018 awards stories", cards: awardStoryCards2018 }] : []),
      {
        kind: "cards",
        title: "More award years",
        cards: awardsArchive.filter((card) => card.href !== awardArchiveHrefByYear[year]),
      },
    ],
  };
...
const legacyAwardCategoryPatterns: Array<{ category: string; pattern: RegExp }> = [
  { category: "Best Convert Support Service", pattern: /best convert (care|support|system)/i },
  { category: "Most Impactful Alimah", pattern: /most impact(?:ful|ul) alimah|\balimah\b/i },
  { category: "Most Impactful Imam", pattern: /most impactful imam|\bimam\b/i },
  { category: "Best Innovative Service", pattern: /best innovation service|best innovative service|most innovative service/i },
  { category: "Best Madrassah Service", pattern: /best madrassah|madrassah service|madrassah services/i },
  { category: "Best Women's Service", pattern: /best women'?s service|best womens service|women'?s services|\bwomen\b/i },
  { category: "Best Youth Service", pattern: /best youth service|best youth services/i },
  { category: "Best Future Design", pattern: /best future design/i },
  { category: "Best Mosque Volunteer", pattern: /best mosque volunteer|volunteer/i },
...
function legacyAwardYear(item: LegacyRouteItem) {
  return item.title.match(/20\d{2}/)?.[0] ?? item.route.match(/20\d{2}/)?.[0] ?? "2024";
}
...
function legacyAwardCategory(title: string) {
  ...
  return legacyAwardCategoryPatterns.find(({ pattern }) => pattern.test(normalizedTitle))?.category ?? "Beacon Mosque Awards";
}
...
function legacyAwardProfilesForYear(year: string) {
  if (year === "2025") return awardRecognitionProfiles2025;
...
function legacyAwardCardsByCategory(year: string, category: string) {
  ...
  const categoryCards = cards.filter((card) => source.find((profile) => profile.href === card.href)?.category === category);
...
function isLegacyAwardShortlistHub(item: LegacyRouteItem) {
  return (
    ...
    (/^(best|most)\b/i.test(item.title) || /^Beacon Mosque 20\d{2}/i.test(item.title))
  );
}
...
function isLegacyAwardActionPage(item: LegacyRouteItem) {
  ...
  return (
    ...
    (/nomination|nominatioin|voting|vote/i.test(text) || isLegacyAwardShortlistHub(item))
  );
}

function isLegacyAwardProfile(item: LegacyRouteItem) {
  return (
    /(shortlist|shortlisted|finalist|winner)/i.test(`${item.title} ${item.route}`) &&
...
legacyRouteItems.forEach((item) => {
  ...
  const archiveHref = awardArchiveHrefByYear[year] ?? "/awards/beacon-mosque-awards-2026/";
  const isNomination = /nomination|nominatioin/i.test(`${item.title} ${item.route}`);
  ...
  const ctas = [
    ...
    { label: "View awards archive", href: "/awards/", variant: "secondary" as const },
  ];

  pageMap[slug] = {
    slug,
    title: item.title,
    eyebrow: isNomination ? "Awards nomination" : isVoting ? "Awards voting" : "Awards shortlist",
    intro: `${item.title} is retained as part of the Beacon Mosque Awards ${year} public programme.`,
    image: year === "2025" ? "/assets/awards/bbma-2025.jpg" : "/assets/interior/awards-gala.jpg",
    imageAlt: "Beacon Mosque awards ceremony",
    ctas,
    sections: [
      {
        ...
        ? [
            {
              ...
              text: "Share the nominee, mosque or institution, contact details and supporting evidence for consideration by the Beacon Mosque Awards team.",
              defaultCategory: category === "Beacon Mosque Awards" ? undefined : category,
            },
          ]
        : []),
      {
        kind: "cards",
        title: category === "Beacon Mosque Awards" ? `${year} award profiles` : `${category} profiles`,
        cards: categoryCards,
      },
      {
        kind: "cards",
...
legacyRouteItems.forEach((item) => {
  ...
  const relatedProfiles = profileCards
    ...
    .filter((card) => profileSource.find((profile) => profile.href === card.href)?.category === category)
    .slice(0, 6);
  ...
  pageMap[slug] = {
    ...
    sections: [
      ...
      {
        kind: "cards",
        title: relatedProfiles.length ? `Related ${category} profiles` : `${year} award profiles`,
        cards: relatedProfiles.length ? relatedProfiles : profileCards.slice(0, 6),
      },
      {
        kind: "cards",
        title: `${year} award categories`,
...
legacyRouteItems.forEach((item) => {
  ...
  const relatedCards = context.cards.filter((card) => card.href !== item.route).slice(0, 6);
  ...
  pageMap[slug] = {
    ...
    ctas: [
      ...
      { label: context.secondaryLabel, href: context.secondaryHref, variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
      ...
      ...(relatedCards.length ? [{ kind: "cards" as const, title: "Related links", cards: relatedCards }] : []),
    ],
  };
});
...
legacyRouteItems.forEach((item) => {
  ...
  pageMap[slug] = {
    ...
    imageAlt: "Beacon Mosque awards ceremony",
    ctas: [
      { label: year ? `Back to Awards ${year}` : "View awards archive", href: archiveHref },
      { label: "Explore current awards", href: "/awards/beacon-mosque-awards-2026/", variant: "secondary" },
    ],
    sections: [
      {
        kind: "text",
...
function legacyOperationalContext(item: LegacyRouteItem) {
  ...
  return {
    eyebrow: "Community resilience",
    title: /directory/i.test(text) ? "Mosque directory and mobilisation" : "COVID-19 response archive",
    image: "/assets/interior/golden-mosque.jpg",
    imageAlt: "Mosque dome at sunset",
...
function isLegacyOperationalPage(item: LegacyRouteItem) {
  return /leadership forum|mosque mobilisation|covid-19 mosque directory|uk mosques.*covid-19 response/i.test(`${item.title} ${item.route}`);
}
...
legacyRouteItems.forEach((item) => {
  ...
  pageMap[slug] = {
    ...
    sections: [
      ...
      {
        kind: "cards",
        title: context.eyebrow === "Leadership forum" ? "Leadership resources" : "Resilience links",
        cards: context.cards,
      },
      ...(context.eyebrow === "Community resilience" ? [{ kind: "criteria" as const, title: "Resilience Hub options", groups: resilienceOptionCriteria }] : []),
    ],
  };
});
...
function legacyUtilityContext(item: LegacyRouteItem) {
  ...
  return {
    ...
    title: /video/i.test(text) ? "Media test archive" : "Development test archive",
    image: "/assets/interior/standards-wide.jpg",
    imageAlt: "Beacon Mosque standards graphic",
    backLabel: "Go to homepage",
    backHref: "/",
...
function isLegacyUtilityRoute(item: LegacyRouteItem) {
  return /cart|checkout|shop|my account|home-beta|sample-home|test|video-test|wasim-test-page/i.test(`${item.title} ${item.route}`) || item.title.trim() === "1";
}
...
function legacyArchiveMeta(item: LegacyRouteItem) {
  if (item.category === "news") return { eyebrow: "News archive", backLabel: "Back to news", backHref: "/category/news/", cards: communityStoryCards.slice(0, 8) };
  if (item.category === "blog") return { eyebrow: "Blog archive", backLabel: "Back to resources", backHref: "/resources/", cards: allResourceCards.slice(0, 8) };
  if (item.category === "mosque-resources" || item.route.includes("guide") || item.route.includes("resource")) {
    return { eyebrow: "Resource archive", backLabel: "Back to resources", backHref: "/resources/", cards: allResourceCards.slice(0, 8) };
  }
  if (item.route.includes("award") || item.route.includes("shortlist") || item.route.includes("mosque-2025") || item.route.includes("mosque-2024")) {
    return { eyebrow: "Awards archive", backLabel: "View awards archive", backHref: "/awards/", cards: awardsArchive.slice(0, 8) };
  }
  return { eyebrow: "Beacon Mosque archive", backLabel: "Back to home", backHref: "/", cards: [...awardsArchive, ...allResourceCards].slice(0, 8) };
}

function legacyArchiveImage(item: LegacyRouteItem) {
  if (item.category === "news" || item.route.includes("award") || item.route.includes("shortlist")) return "/assets/interior/awards-gala.jpg";
  if (item.category === "blog" || item.route.includes("guide") || item.route.includes("resource")) return "/assets/interior/standards-wide.jpg";
...
legacyRouteItems.forEach((item) => {
  ...
  const relatedCards = meta.cards.filter((card) => card.href !== item.route).slice(0, 6);
  ...
  pageMap[slug] = {
    ...
    sections: [
      ...
      ...(relatedCards.length ? [{ kind: "cards" as const, title: "Continue exploring", cards: relatedCards }] : []),
    ],
  };
});
...
export async function getPageStaticParams() {
  const slugs = Array.from(new Set([...Object.keys(pages), ...(await getWordPressPublicSlugs())]));
